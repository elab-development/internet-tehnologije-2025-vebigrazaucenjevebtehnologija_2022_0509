    ...
    try:
        ...
        levels = [
            models.Level(
                ...
                target_code="rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR"
            ),
            models.Level(
                ...
                target_code="rnbqkbnr/pppp1ppp/8/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R"
            ),
            models.Level(
                ...
                target_code="rnbqkbnr/pppp1ppp/5n2/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R"
            )
        ]
